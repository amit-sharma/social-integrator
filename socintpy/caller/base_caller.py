class BaseCaller(object):
  ...
  def call_multiple_methods(self, user, methodnames_array, get_data_fun):
    response = {}
    for method_name in methodnames_array:
      response[method_name] = get_data_fun(self, user = user, method = method_name, api_key = self.api_key)
    #import pprint
